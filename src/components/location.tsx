    ...
    return (
        <Screen id="location" className="relative flex flex-col space-y-6">
            ...
            <div className="px-3 w-full flex-1 z-1">
                <div className="p-5 bg-white/2 backdrop-blur-md pt-30 w-full h-full flex flex-col space-y-4 text-center rounded-t-full rounded-b-3xl border-b-0 border-2 border-red-100 rounded-2xl">
